...
### Documentation Site: `docs.rok.dev`

**Built with**: TanStack Start (React, Vite, SSR)  
**Repository**: `rok-workspace/docs`  
**Deployment**: Vercel / Netlify (auto-deploy on main branch)
...
**Features**:
- ✅ **TanStack Start** — Fast, modern, SSR-ready
- ✅ **MDX Support** — Interactive docs with live code
- ✅ **Search** — Algolia DocSearch integration
- ✅ **Dark Mode** — Auto-switching theme
- ✅ **Versioned Docs** — Per-crate versioning
- ✅ **API Reference** — Auto-generated from rustdoc
- ✅ **Playground** — Live Rust code execution (via WebAssembly)

---

### docs/ Folder Structure

All documentation lives in the `docs/` folder at the workspace root:
...
│       └── favicon.ico
│
├── README.md              ← Links to docs.rok.dev
├── ECOSYSTEM.md           ← This file
...
Each crate has dedicated documentation:
...
# Import into docs site
./scripts/import-rustdoc.sh
```
